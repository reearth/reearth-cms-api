    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class comments(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Comment'], typing.List['Comment']],
...
class AssetCommentList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def asset_comment_list(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def asset_comment_list(
        ...
        return self._asset_comment_list_oapg(
