...
class Comment(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["authorType"]) -> MetaOapg.properties.authorType: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["authorType"]) -> typing.Union[MetaOapg.properties.authorType, schemas.Unset]: ...
