...
class RefOrVersion(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ref", "version", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ref", "version", ], str]):
